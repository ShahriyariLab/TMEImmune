...
geneset = {"immune": immune_istme, "stromal": stromal_istme}

# path = "/Users/qiluzhou/Desktop/umass/research/score/data/chol_tcga_clean.txt"
...
def ISTMEscore(df):
    ...
    df_ranked = istme_data.rank(axis = 0, method = "average")
    ...
    for sig in geneset.keys():
        ...
        for sample in range(0, istme_data.shape[1]):
